...
setup(
    ...
    version='0.1',
    packages=['venv.Lib.site-packages.dateutil', 'venv.Lib.site-packages.dateutil.tz',
              'venv.Lib.site-packages.dateutil.parser', 'venv.Lib.site-packages.dateutil.zoneinfo',
              'venv.Lib.site-packages.freezegun', 'venv.Lib.site-packages.pip-10.0.1-py3.6.egg.pip',
    ...
    url='https://gitlab.com/szabadkai1/due-date-calculator',
    license='',
    author='szabadkai',
